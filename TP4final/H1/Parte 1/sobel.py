...
#Funcion que, dada una imagen, aplica el operador de sobel
def sobel(imagen):
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Como usar el programa: python sobel.py (ruta-imagen)")
        sys.exit(1)
    ...
    nombre_archivo = nombre_archivo + "_sobel.jpg"

    #Guardo la imagen}
    cv2.imwrite(nombre_archivo, imagen_sobel )

    print(f"Imagen filtrada! Nombre del archivo:", nombre_archivo)