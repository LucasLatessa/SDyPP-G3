...
#H6
#Contactos 
sudo docker run --rm --name h6contactos -p 8086:8080 lucaslatessa/h6contactos >> logfileh6r.txt 2>&1 &
#ServCli.py
#sudo docker run --rm --name h6 -p $PUERTO_EXT:8080 lucaslatessa/h6 35.196.99.208 8086 &
